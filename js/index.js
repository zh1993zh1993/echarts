...
(function(){
  ...
  option = {
    ...
    xAxis: [
        {
            type: 'category',
            data: ['旅游行业', '教育培训', '医疗行业', '电商行业', '社交行业', '金融行业'],
            axisTick: {
                alignWithLabel: true
            },
            // 修改刻度标签 相关样式 xAxis下的axisLable
            axisLabel:{
...
(function(){
  ...
  option = {
    grid: {
        ...
        top:'10%',
        bottom: '10%',
        // containLabel: true 不考虑刻度标签的位置能让图表变大
    },
    // 不显示X轴的相关信息
    xAxis: {
       show:false
 ...
 // {a}系列名(条),{b}数据名(yAxis里的data),{c}数据值(series里的data)
              formatter:'{c}%' //自动解析本对象data里的数据
            }
        },
        {
            name: '框',
...
(function(){
  ...
  legend: {
    // 如果series里面有name属性，name就可以去掉此图组件里的data属性
      // data: ['邮件营销', '联盟广告'],
      // 修改图例组件里的文字颜色
      textStyle:{
        color:'#4c9bfd'
...
(function(){
  ...
  option = {
    ...
    legend: {
        ...
        // data: ["0岁以下", "20-29岁", "30-39岁", "40-49岁", "50岁以上"] series里有name属性可省略
    },
    series: [
        {
            name: '访问来源',
            type: 'pie',
            /*可以修改饼形图的大小 第一个值是内圆的半径，第二个是外圆的半径*/
            radius: ['40%', '60%'],
            center:["50%","45%"],
